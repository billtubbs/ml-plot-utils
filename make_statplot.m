function make_statplot(Y_line, Y_lower, Y_upper, x, y_labels, ...
    line_label, area_label, x_label, y_lim)
% make_statplot(Y_line, Y_lower, Y_upper, x, y_labels, fill_labels, ...
%     x_label, y_lim)
